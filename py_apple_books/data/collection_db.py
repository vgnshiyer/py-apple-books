...
def get_all_collections(fields: list = None):
    if fields == None:
...
def get_collection_by_id(collection_id: str, fields: list = None):
    if fields == None:
        raise ValueError("fields not specified")
...
def get_collections_by_book_id(book_id: str, fields: list = None):
    if fields == None:
        raise ValueError("fields not specified")
